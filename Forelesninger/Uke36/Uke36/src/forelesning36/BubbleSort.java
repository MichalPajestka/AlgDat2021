...
public class BubbleSort {
    ...
    public static void main(String[]strings) {
        ...
        int index3 = binarySearchRecursiv(values, 9, 0, values.length - 1);
        System.out.println("Fant tallet 9 rekursivt på " + index3);

        int index4 = binarySearchRecursiv(values, 11, 0, values.length - 1);
        System.out.println("Fant tallet 11 rekursivt på " + index4);


    }

    public static int binarySearchRecursiv(int[] values, int search_value, int l, int r){
        int m = (l + r) / 2;
        ...
        if(values[m] > search_value) {
            r = m - 1;
            return binarySearchRecursiv(values, search_value, l, r);
        }
    ...
    public static int binarySearch(int[] values, int search_value) {
        ...
        while (l <= r) {
            System.out.println("Sjekker intervallet [" + 1 + ", " + r + "l");
            m = (l + r) / 2;
